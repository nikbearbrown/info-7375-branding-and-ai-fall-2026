# Assignment 6 — Measurement and attribution
...
Bundle [Lesson 9](../../lessons/09-measurement-and-attribution/README.md) into one contribution to your running brand project. The lesson Assessments are ungraded.

## Predict

Will an apparent improvement persist after you check denominators and segment composition? Save the expectation before the relevant output or feedback.

## Build It

Build Python functions for conversion rates and differences using explicit numerators and denominators. Preserve raw counts, time windows, segments, and synthetic/observed labels.

## Use It

Ask Claude to interpret a small synthetic campaign table, then audit its conclusions. Separate brand measures from short-term response measures and observational differences from causal effects.

## Ship It

Submit measurement plan, raw table, calculation code, and interpretation audit. Include the implementation, tests, inputs, actual outputs, source credits, and [submission records](../../templates/README.md). Post the final checked version to the designated GitHub location and upload the matching version to Canvas.

## Verify

Check 10/100 and 15/300: more conversions can coexist with a lower rate. Test zero denominators and counts outside valid ranges. This comparison alone does not establish a campaign effect.
...
**AI should** calculate and propose explanations.

**Human should** choose meaningful measures and judge what the evidence can support.
